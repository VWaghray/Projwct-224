...
def Bike_control():
    dropped_vehicle.apply_control(carla.VehicleControl(throttle=0.59))
    time.sleep(15)
    dropped_vehicle.apply_control(carla.VehicleControl(hand_brake=True))
    dropped_vehicle.apply_control(carla.VehicleControl(steer=-0.38, throttle=0.3))
    dropped_vehicle.set_light_state(carla.VehicleLightState(carla.VehicleLightState.HighBeam|carla.VehicleLightState.Brake|carla.VehicleLightState.LeftBlinker))
    time.sleep(2)
    dropped_vehicle.apply_control(carla.VehicleControl(throttle=0.31))
    dropped_vehicle.set_light_state(carla.VehicleLightState(carla.VehicleLightState.HighBeam|carla.VehicleLightState.Brake))
    time.sleep(3)
    dropped_vehicle.apply_control(carla.VehicleControl(hand_brake=True))
